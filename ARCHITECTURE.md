...
- extracao de PWA e updates em `js/core/pwa.js`
- extracao de dados em `js/data/salas.js`
- extracao de features em `js/features/home.js`, `js/features/history.js`, `js/features/busca.js`, `js/features/salas.js`, `js/features/scanner.js`, `js/features/sync.js`, `js/features/nopat.js`, `js/features/admin.js` e `js/features/dashboard.js`
